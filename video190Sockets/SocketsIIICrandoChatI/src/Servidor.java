...
class MarcoServidor extends JFrame implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            EnvioPaquetes paquete_recibido;//informacion que le llega en ese paquete por la red
            ...
            while (true) {
                ...
                ObjectInputStream flujoDatosEntrada = new ObjectInputStream(miServer.getInputStream());//el input para recibir, el output para enviar
                ...
                //necesitamos crear un socket el cual es el medio por cual va a viajar los datos desde el servidor al otro cliente
                Socket enviaDestinatario = new Socket(ip, 9090);
                
                ObjectOutputStream paqueteReenvio=new ObjectOutputStream(enviaDestinatario.getOutputStream());//creamos un paquete en el cual usamos el socket para enviarlo
                
                paqueteReenvio.writeObject(paquete_recibido);//en ese objeto metemos con los datos del paquete recibido
