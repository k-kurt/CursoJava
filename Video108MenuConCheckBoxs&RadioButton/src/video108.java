...
//		creacion_items("estilo", "Cursiva", "", Font.ITALIC, 12);
		JCheckBoxMenuItem negrita=new JCheckBoxMenuItem("Negrita",new ImageIcon("D:/Cursos Udemy/Java/CursoJava/PROCESADOR DE TEXTOS/src/iconos/texto-en-negrita.gif"));
		JCheckBoxMenuItem cursiva=new JCheckBoxMenuItem("Cursiva",new ImageIcon("D:/Cursos Udemy/Java/CursoJava/PROCESADOR DE TEXTOS/src/iconos/boton-de-cursiva.gif"));
	...
	public void creacion_items(String menu_pertenece,String nom_item,String tipo_fuente,int tipo_estilo,int tamanio_letra) {
		...
		if(menu_pertenece=="fuente") {
			 ...
			 * else if(menu_pertenece=="estilo") { estilo.add(itemMenu);
			 * if(tipo_estilo==Font.BOLD) { itemMenu.addActionListener(new
			 * StyledEditorKit.BoldAction()); }else if(tipo_estilo==Font.ITALIC) {
